defmodule PhoenixRiseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixRiseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixRiseWeb.Gettext, "errors", msg, opts)
    end
  end
